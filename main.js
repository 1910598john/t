                                ...
                                .then(response => {
                                    ...
                                    <div class="watch-window">
                                        <div>
                                            ...
                                            <iframe id="show" src="https://vidsrc.xyz/embed/tv?tmdb=${data}&season=1&episode=1" allowfullscreen></iframe>
                                        </div>
                                    </div>`);
                                    
                                    $(".dl-button").css("bottom", "-90px");
                                    ...
                                    function attachSeasonClickEvents() {
                                        $(".seasons-container > div").click(function(event){
                                            ...
                                            $(".episode").click(function(event){
                                                ...
                                                let ep = $(this).data("ep");
                                                document.getElementById("show").src = `https://vidsrc.xyz/embed/tv?tmdb=${data}&season=${season}&episode=${ep}`
                                            })
